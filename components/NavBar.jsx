...
export default function NavBar() {
    ...
    return (
        <>
            <div className={`w-full ${scrolled ? "bg-custom-blue-dark" : "bg-custom-blue-dark"} px-6 h-20 text-white flex items-center justify-between fixed top-0 left-0 z-50`}>
                <div className=' h-full flex items-center justify-center gap-x-3'>
                    <img src="/logo.png" alt="logo"  className='w-11 h-11 rounded-full '/>
                    <p className='uppercase font-semibold tracking-widest text-lg'>SNC JOB PORTAL</p>
                </div>
                ...
                <div className='px-2 h-full hidden items-center justify-center lg:flex ' >
                    {
                        user !== null ? (
                            ...
                            <>
                                <Link href={'/auth/login'} className='px-4 py-2 border border-white rounded uppercase tracking-widest mx-4   transition-all duration-700 hover:bg-white font-semibold text-base hover:text-custom-blue-dark'>Login</Link>
                                <Link href={'/auth/register'} className='px-4 py-2 border border-white rounded uppercase tracking-widest mx-4   text-custom-blue-dark bg-white transition-all duration-700 hover:bg-transparent font-semibold text-base hover:text-white'>REGISTER</Link>
                            </>
                        )
                    }
                </div>
                ...
                {
                    isOpen && (
                        <div ref={ref} className='flex w-full py-2 animate-fade-in-down  bg-custom-blue-dark transition-all fade duration-1000 absolute top-20 left-0  items-center justify-center flex-col '>
